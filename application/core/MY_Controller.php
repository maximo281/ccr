...
class MY_Controller extends MX_Controller {
	...
	protected $mMenu = array();
        ...
        protected $mWorks = array();
        protected $mMeet = array();
	...
	private function _setup()
	{
		...
		$this->mMenu = empty($site_config['menu']) ? array() : $site_config['menu'];
                /*Carga servicios*/
                $this->mWorks = empty($site_config['works']) ? array():$site_config['works'];
                $this->mServices = empty($site_config['services']) ? array():$site_config['services'];
                $this->mMeet = empty ($site_config['meet'])? array():$site_config['meet'];
	...
	protected function render($view_file, $layout = 'default')
	{
		...
		/**/
                $this->mViewData['services'] = $this->mServices;
                 $this->mViewData['works'] = $this->mWorks;
                 $this->mViewData['meet']=$this->mMeet;
                /**/
